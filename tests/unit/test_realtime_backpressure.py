...
class TestBackpressureHandlerHardening:
    ...
    @pytest.mark.asyncio
    async def test_intermediate_message_dropping(self, backpressure_handler, websocket_mock):
    ...
    @pytest.mark.asyncio
    async def test_final_message_preservation(self, backpressure_handler, websocket_mock):
    ...
    @pytest.mark.asyncio
    async def test_connection_lost_message_storage(self, backpressure_handler, websocket_mock, redis_mock):

...
class TestReliabilityIntegration:
    ...
    async def test_circuit_breaker_opens_and_resets(self, base_adapter_with_redis):
        ...
        base_adapter_with_redis.circuit_breaker_state = base_adapter_with_redis.base_adapter.AdapterStatus.CLOSED
    ...
    async def test_email_adapter_with_redis(self, email_adapter_with_redis):
        ...
        result = await email_adapter_with_redis.send_email(message, "tenant123", "user456")
    ...
    async def test_email_adapter_with_saga(self, email_adapter_with_redis):
        ...
        result = await email_adapter_with_redis.send_email_with_saga(message, "tenant123", "user456")
    ...
    @pytest.mark.asyncio
    async def test_end_to_end_reliability(self, base_adapter_with_redis, saga_adapter_with_redis):
    ...
    @pytest.mark.asyncio
    async def test_metrics_aggregation(self, base_adapter_with_redis, saga_adapter_with_redis):

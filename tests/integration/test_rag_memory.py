...
class TestRAGPermissionedRetrieval:
    ...
    async def test_semantic_search_accuracy(self):
        ...
        programming_docs = [doc for doc in results if doc["metadata"]["topic"] == "programming"]
    ...
    async def test_memory_context_retrieval(self):
        ...
        assert context[1]["content"] == "I can help you with that. What's your order number?"
    ...
    async def test_memory_performance_under_load(self):
        ...
        await asyncio.gather(*[
            memory_manager.store_document(doc) for doc in documents
        ])

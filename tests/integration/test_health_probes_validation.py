...
class TestHealthProbesValidation:
    ...
    def test_health_probes_have_valid_initial_delay_relationships(self):
        ...
        for deployment in deployments:
            ...
            assert liveness_delay >= readiness_delay, "Liveness probe initial delay should be >= readiness probe initial delay"
    ...
    def test_health_probes_have_valid_period_relationships(self):
        ...
        for deployment in deployments:
            ...
            assert liveness_period >= readiness_period, "Liveness probe period should be >= readiness probe period"

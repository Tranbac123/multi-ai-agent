...
class TestOrchestratorIntegration:
    ...
    @pytest.mark.asyncio
    async def test_get_run_events(self, orchestrator, sample_agent_spec, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_tenant_isolation(self, orchestrator, sample_agent_spec, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_runs(self, orchestrator, sample_agent_spec, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_error_handling(self, orchestrator, sample_agent_spec, sample_context):
        """Test error handling."""
        tenant_id = uuid4()

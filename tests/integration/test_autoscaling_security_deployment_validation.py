"""Integration tests for autoscaling and security configuration deployment validation."""
...
class TestAutoscalingSecurityDeploymentValidation:
    """Test autoscaling and security configuration deployment validation."""
    
    def test_keda_deployment_validation(self):
        """Test KEDA deployment validation."""
    ...
    def test_hpa_deployment_validation(self):
        """Test HPA deployment validation."""
        ...
        for hpa in hpas:
            ...
            for metric in metrics:
                if metric.get("type") == "Resource":
                    ...
                    assert "averageUtilization" in target or "averageValue" in target
    
    def test_health_probes_deployment_validation(self):
        """Test health probes deployment validation."""
    ...
    def test_networkpolicy_deployment_validation(self):
        """Test NetworkPolicy deployment validation."""
                    ...
                    if "from" in rule:
                        for source in rule["from"]:
                            if "namespaceSelector" in source:
                                ...
                                assert len(source["namespaceSelector"]["matchLabels"]) > 0
                    ...
                    if "to" in rule:
                        for destination in rule["to"]:
                            if "namespaceSelector" in destination:
                                ...
                                assert len(destination["namespaceSelector"]["matchLabels"]) > 0
                            if "podSelector" in destination:
                                assert "matchLabels" in destination["podSelector"]
                                assert len(destination["podSelector"]["matchLabels"]) > 0
    ...
    def test_all_deployments_have_required_services(self):
        ...
        for deployment in deployments:
            ...
            assert deployment_name in service_names, f"Deployment {deployment_name} should have a corresponding service"
    ...
    def test_all_deployments_have_required_configmaps(self):
        ...
        for deployment in deployments:
            ...
            assert configmap_name in configmap_names, f"Deployment {deployment_name} should have a corresponding ConfigMap {configmap_name}"
    ...
    def test_all_deployments_have_required_secrets(self):
        ...
        for deployment in deployments:
            ...
            assert secret_name in secret_names, f"Deployment {deployment_name} should have a corresponding Secret {secret_name}"
    ...
    def test_all_deployments_have_required_serviceaccounts(self):
        ...
        for deployment in deployments:
            ...
            assert serviceaccount_name in serviceaccount_names, f"Deployment {deployment_name} should have a corresponding ServiceAccount {serviceaccount_name}"
    ...
    def test_all_deployments_have_required_networkpolicies(self):
        ...
        for expected_netpol in expected_netpols:
            assert expected_netpol in netpol_names, f"NetworkPolicy {expected_netpol} should exist"
    ...
    def test_all_deployments_have_required_scaled_objects(self):
        ...
        for expected_scaled_object in expected_scaled_objects:
            assert expected_scaled_object in scaled_object_names, f"ScaledObject {expected_scaled_object} should exist"

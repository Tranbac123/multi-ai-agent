    ...
    def test_keda_scaled_objects_valid(self):
        ...
        for file_path in [keda_file, enhanced_keda_file]:
            if file_path.exists():
                ...
                scaled_objects = [
                    doc for doc in documents if doc.get("kind") == "ScaledObject"
                ]

...
class TestKEDAValidation:
    ...
    def test_scaled_objects_target_existing_deployments(self):
        ...
        for scaled_object in scaled_objects:
            ...
            assert target_name in deployment_names, f"ScaledObject {scaled_object['metadata']['name']} targets non-existent deployment {target_name}"
    ...
    def test_scaled_objects_have_proper_namespace(self):
        ...
        for scaled_object in scaled_objects:
            ...
            assert namespace == "production", f"ScaledObject {scaled_object['metadata']['name']} should be in production namespace"

...
async def get_comprehensive_analytics(
    ...
    try:
        ...
        logger.error(
            "Failed to get comprehensive analytics", error=str(e), tenant_id=tenant_id
        )
        raise HTTPException(
            status_code=500, detail="Failed to get comprehensive analytics"
        )
...
async def list_tenants():
    ...
    try:
        ...
        return JSONResponse(content={"tenants": tenants, "total_count": len(tenants)})
...
async def get_dashboard(dashboard_name: str):
    ...
    try:
        ...
        logger.error(
            "Failed to get dashboard", error=str(e), dashboard_name=dashboard_name
        )

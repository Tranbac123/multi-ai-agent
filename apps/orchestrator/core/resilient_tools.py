...
from libs.adapters.saga_pattern import SagaOrchestrator, saga_manager
...
class ResilientOrderTool:
    ...
    def __init__(self):
        ...
        self.base_url = "https://api.orders.example.com"  # Replace with actual Order API
...
class ResilientPaymentTool:
    ...
    def __init__(self):
        ...
        self.base_url = "https://api.payments.example.com"  # Replace with actual Payment API

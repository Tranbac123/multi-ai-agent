...
class FeatureExtractor:
    ...
    def __init__(self):
        self.reasoning_keywords = [
            "analyze", "compare", "evaluate", "reason", "explain", "why", "how",
            "because", "therefore", "however", "although", "consider", "think"
        ]
        self.domain_keywords = {
            "finance": ["money", "cost", "price", "budget", "investment", "revenue"],
            "legal": ["law", "legal", "contract", "agreement", "liability", "compliance"],
            "medical": ["health", "medical", "patient", "diagnosis", "treatment", "symptoms"],
            "ecommerce": ["product", "order", "shipping", "payment", "cart", "checkout"]
        }

...
class DocumentProcessor:
    ...
    async def process_document(
        ...
        try:
            ...
            if await self._is_document_processed(doc_hash, tenant_id):
                logger.info(
                    "Document already processed", doc_hash=doc_hash, tenant_id=tenant_id
                )
    ...
    async def _validate_file(self, file_path: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {"size": size, "mime_type": mime_type, "extension": path.suffix}
    ...
    async def _get_existing_document(
        self, doc_hash: str, tenant_id: str
    ) -> Dict[str, Any]:
    ...
    async def _process_xlsx(self, file_path: str) -> Tuple[str, Dict[str, Any]]:
        """Process XLSX file."""
        content = ""
        metadata = {"type": "xlsx", "sheet_count": 0, "has_formulas": False}
    ...
    async def _process_json(self, file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        try:
            ...
            metadata = {"type": "json", "is_valid_json": False, "structure": {}}

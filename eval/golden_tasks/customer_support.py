        ...
        return [
            ...
            GoldenTask(
                ...
                expected_output={
                    ...
                    "confidence": 0.8,
                    "actions": ["search_products", "filter_by_budget", "provide_recommendations"]
                },
                expected_tier=RouterTier.SLM_B,
            ...
            GoldenTask(
                ...
                expected_output={
                    ...
                    "confidence": 0.85,
                    "actions": ["check_order_details", "verify_return_policy", "initiate_return"]
                },
                expected_tier=RouterTier.SLM_B,
            ...
            GoldenTask(
                ...
                input_data={
                    ...
                    "troubleshooting_steps": ["updated drivers", "reinstalled Docker", "checked resources"],
                    "error_logs": "container runtime error"
                },
                expected_output={
                    "response": "This is a complex technical issue. Let me help you troubleshoot step by step...",
                    "confidence": 0.7,
                    "actions": ["analyze_error_logs", "check_system_compatibility", "provide_troubleshooting_steps", "escalate_to_technical_team"]
                },
            ...
            GoldenTask(
                ...
                expected_output={
                    ...
                    "confidence": 0.8,
                    "actions": ["investigate_billing", "escalate_to_manager", "provide_refund", "update_account_security"]
                },
                expected_tier=RouterTier.LLM,
                expected_confidence=0.7,
            ...
            GoldenTask(
                ...
                expected_output={
                    ...
                    "confidence": 0.6,
                    "actions": ["detect_language", "provide_translation", "continue_in_english"]
                },
                expected_tier=RouterTier.SLM_B,
                expected_confidence=0.6,
            ...
            GoldenTask(
                ...
                expected_output={
                    ...
                    "confidence": 0.5,
                    "actions": ["ask_for_clarification", "provide_general_help_options"]
                },
                expected_tier=RouterTier.SLM_A,
